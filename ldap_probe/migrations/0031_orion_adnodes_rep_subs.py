# Generated by Django 2.2.6 on 2019-12-09 23:34
    ...
    subscriptions = [
        {
            ...
            'email_subject': (
                'Network Nodes Providing AD Services Improperly Defined'
                ' on the Orion Server'),
            'alternate_email_subject': '',
            'headers': (
                'node__node_caption,node__ip_address,orion_url'),
        },
        {
            ...
            'template_prefix': 'email/',
            'email_subject': (
                'Network Nodes Providing AD Services With Duplicate Definitions'
                ' on the Orion Server'),
            'alternate_email_subject': '',
            'headers': (
                'node__node_caption,node__ip_address,orion_url'),
