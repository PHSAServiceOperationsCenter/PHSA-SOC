...
`Django settings <https://docs.djangoproject.com/en/2.2/topics/settings/>`_

For the full list of settings and their values, see
`Settings <https://docs.djangoproject.com/en/2.2/ref/settings/>`_
...
<https://www.solarwinds.com/solutions/orion>`_
...
<https://www.solarwinds.com/solutions/orion>`_ network address be configured
from the `Orion Server Host Name or IP Address
<../../../admin/dynamic_preferences/globalpreferencemodel/?q=orion_hostname&o=2>`_
...
<https://www.solarwinds.com/solutions/orion>`_ from the `Orion Server Root URL
<../../../admin/dynamic_preferences/globalpreferencemodel/?q=orion_server_url&o=2>`_.
...
<../../../admin/dynamic_preferences/globalpreferencemodel/?q=orion_rest_url&o=2>`_
...
<../../../admin/dynamic_preferences/globalpreferencemodel/?q=orion_user&o=2>`_
...
<https://www.solarwinds.com/solutions/orion>`_ when issuing ``REST`` requests
...
<https://en.wikipedia.org/wiki/Representational_state_transfer>`_ end points
on the `SolarWinds Orion server <https://www.solarwinds.com/solutions/orion>`_
...
Configurable from `Orion Server User Name
<../../../admin/dynamic_preferences/globalpreferencemodel/?q=orion_retry&o=2>`_
...
Configurable from `Orion Server User Name
<../../../admin/dynamic_preferences/globalpreferencemodel/?q=orion_backoff_factor&o=2>`_
...
<https://docs.celeryproject.org/en/latest/userguide/configuration.html#accept-content>`_

The ``Celery`` documentation recommends against using  the `pickle
<https://docs.python.org/3/library/pickle.html#module-pickle>`_ serializer
