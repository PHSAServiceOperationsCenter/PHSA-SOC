...
class TestSslCertTrackerModels(TestCase):
    ...
    def setUp(self):
        ...
        NmapCertsData.objects.create(orion_id='12345',
                                     ...
                                     not_before=datetime(
                                         2018, 1, 21, 14, 32, 24, 38),
                                     not_after=datetime(
                                         2018, 11, 21, 19, 30, 45, 21),
                                     xml_data='',
    ...
    def test_not_before_content_type(self):
        ...
        self.assertEqual(str(expected_object_not_before),
                         "2018-01-21 14:32:24+00:00")
    ...
    def test_not_after_content_type(self):
        ...
        self.assertEqual(str(expected_object_not_after),
                         "2018-11-21 19:30:45+00:00")
    ...
    def test_md5(self):
        ...
        self.assertEqual(expected_object_md5,
                         '57adc7886d93a03d934ae691178748b7')

    def test_sha1(self):
        """testing sha1 field"""
        expected_object_sha1 = f'{self.obj.sha1}'
        self.assertEqual(expected_object_sha1,
                         'ae699d5ebddce6ed574111262f19bb18efbe73b0')

    def test_save(self):
        """testing save record"""
        NmapCertsData.objects.filter(
            md5="57adc7886d93a03d934ae691178748b7").update(bits="1024")
        bits_entry = NmapCertsData.objects.filter(
            md5="57adc7886d93a03d934ae691178748b7")
        for fld in bits_entry:
            self.assertEqual(fld.bits, '1024')
        NmapCertsData.objects.filter(
            md5="57adc7886d93a03d934ae691178748b7").update(bits="2048")
        bits_entry = NmapCertsData.objects.filter(
            md5="57adc7886d93a03d934ae691178748b7")
        for fld in bits_entry:
